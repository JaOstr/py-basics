# -*- coding: utf-8 -*-
# https://github.com/zeque92/RealTime3DwithPython/blob/master/Cubester/Cubester.py
# https://oldskoolpython.blogspot.com/2022/09/cubester-rubiks-cube-simulator.html
import pygame
import numpy as np
